    ...
    public class TasksController : BaseController
    {
        ...
        public ActionResult Open(string taskId, string mode)
        {
            ...
            if (mode == "open") {
                ...
                vm.SequenceOfBlocks = BlockGenerator.RandomizeBlocks(BlockGenerator.Code2Blocks(vm.Task.Standard.StandardFile, vm.Task.DifficultyLevelId.Value));
            ...
            else
            {
                ...
                var codeBlocks = BlockGenerator.Code2Blocks(vm.Task.Standard.StandardFile, vm.Task.DifficultyLevelId.Value);
